...
\PassOptionsToPackage{table}{xcolor} % DY: adding this resolves the option clash with xcolor later on
...
\usepackage{setspace}
\usepackage{titlesec}
\usepackage[table]{xcolor} % DY: LaTeX Error: Option clash for package xcolor. Moving it elsewhere did not work.
\usepackage{float}
