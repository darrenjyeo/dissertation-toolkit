...
\PassOptionsToPackage{table}{xcolor} % needed to resolve "LaTeX error: Option clash with xcolor", due to different sets of options required by different packages that depend on xcolor
